...
function phRunTrial() {
  ...
  if (bad) { fail("Trial failed: wrong result", "The program finished but " + phEsc(bad) + ". The answer must be correct. Speed does not count when the answer is wrong."); return; }
